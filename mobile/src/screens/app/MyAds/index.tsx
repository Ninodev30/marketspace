...
const MyAds: React.FC = () => {
    const [adList, setAdList] = useState<string[]>(['Tênis vermelho', 'Bicicleta', 'Sofá', 'Bunda', 'Dinheiro', 'Gaveta', 'Tênis vermelho, Bicicleta', 'Sofá', 'Bunda', 'Dinheiro', 'Gaveta', 'Tênis vermelho', 'Bicicleta', 'Sofá', 'Bunda', 'Dinheiro', 'Gaveta'])
    ...
    const handleFilterOption: (type: activedFilter) => void = (type) => {
        ...
        <View style={styles.container}>
            <View style={styles.content}>
                ...
                <View style={styles.adListHeader}>
                    <Text style={styles.adListHeaderTitle}>
                        {9} anúncios
                    </Text>
                    <View style={styles.adListHeaderFilter}>
                        <Pressable
                            style={[
                                styles.adListHeaderFilterContent,
                                isShowFilterOptions && styles.adListHeaderFilterContentSelected
                            ]}
                            onPress={() => setIsShowFilterOptions(!isShowFilterOptions)}
                        >
                            <Text style={styles.adListHeaderTitle}>
                                {filterOption === 'all' ? 'Todos' : filterOption === 'actived' ? 'Ativos' : 'Inativos'}
                            </Text>
                            {isShowFilterOptions ?
                                <CaretUp
                                    size={iconsTheme.caret.size}
                                    color={iconsTheme.caret.color}
                                />
                                :
                                <CaretDown
                                    size={iconsTheme.caret.size}
                        ...
                        {isShowFilterOptions &&
                            <View style={styles.adListHeaderFilterBox}>
                                <Pressable onPress={() => handleFilterOption('all')}>
                                    <Text style={[
                                        styles.adListHeaderTitle,
                                        filterOption === 'all' && styles.adListHeaderFilterTitleSelected
                                    ]}>
                                        Todos
                                    </Text>
                                </Pressable>
                                <Pressable onPress={() => handleFilterOption('actived')}>
                                    <Text style={[
                                        styles.adListHeaderTitle,
                                        filterOption === 'actived' && styles.adListHeaderFilterTitleSelected
                                    ]}>
                                        Ativos
                                    </Text>
                                </Pressable>
                                <Pressable onPress={() => handleFilterOption('inactived')}>
                                    <Text style={[
                                        styles.adListHeaderTitle,
                                        filterOption === 'inactived' && styles.adListHeaderFilterTitleSelected
                                    ]}>
                                        Inativos
                                    </Text>
                                </Pressable>
