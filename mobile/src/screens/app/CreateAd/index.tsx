        ...
        <View style={styles.container}>
            <ScrollView style={styles.content}>
                ...
                <View style={styles.imagesContainer}>
                    ...
                    <View style={styles.imagesContainer}>
                        <TouchableOpacity style={styles.imagesBox}>
                            <Image
                                source={{ uri: adPhoto }}
                                style={styles.image}
                            />
